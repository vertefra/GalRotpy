...
def input_component(component):
    ...
    try:
        ...
        print(
            "No valid Mass for",
            component,
            ". It will be taken the default mass:",
            component_mass,
            "M_sun",
        )
    ...
    try:
        ...
        print(
            "No valid Radial Scale Length for",
            component,
            ". It will be taken the default Radial Scale Lenght:",
            component_scale_a,
            "kpc",
        )

    if component not in [
        Components_names.Exponential_disk,
        Components_names.Dark_halo,
        Components_names.Burkert_halo,
    ]:
        try:
            component_scale_b = float(input("Vertical Scale Length (in kpc):"))
        except:
            print(
                "No valid Vertical Scale Length for",
                component,
                ". It will be taken the default Vertical Scale Lenght:",
                component_scale_b,
                "kpc",
            )
